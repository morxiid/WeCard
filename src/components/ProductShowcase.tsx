  ...
  const products = [
    {
      ...
      price: "349 MAD",
      description: "Custom-designed cards with your branding. Perfect for professionals who want to stand out.",
      features: ["Custom Design", "Your Branding", "Advanced Profile", "Analytics Dashboard"],
    ...
    },
    {
      ...
      price: "249 MAD",
      description: "Perfect for individuals and small businesses. Features the WeCard logo and essential NFC functionality.",
      features: ["NFC Technology", "Affordable and sleek", "WeCard Branding", "Social Links"],
    ...
    },
    {
      ...
      price: "159 MAD",
      description: "Specifically designed to collect Google reviews. Direct link for clients to leave feedback instantly.",
      features: ["Direct Google Link", "Review Optimization", "QR Code Backup", "Success Tracking"],
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Choose Your <span className="bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text text-transparent">WeCard</span>
          </h2>
          <p className="text-xl text-gray-300 max-w-2xl mx-auto">
            From personal networking to business growth, we have the perfect NFC solution for every need.
          </p>
        </div>
